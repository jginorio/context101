...
- Provider connectors need their own OAuth clients/secrets. Self-host front door: `context101 connectors` (TTY wizard) or `context101 connectors setup google|notion|github` (writes Secrets Manager; values never printed).
